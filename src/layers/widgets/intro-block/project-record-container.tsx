        ...
        <div className="flex flex-col gap-10">
          ...
          >
            <div className="grid grid-cols-1 items-center md:flex md:justify-evenly">
              ...
              <div className="flex h-full flex-col justify-center gap-1 rounded-br-lg px-3 py-5 md:max-w-[400px]">
                <p>
                ...
                <p>
                  ...
                  홈페이지입니다. 당시 기획자분께서 기획 업무가 처음이시고 개발
                  지식도 없으셨지만 차근차근 소통하며 주어진 업무를 잘
                  마쳤습니다. 또한 검색엔진 노출을 고려해 SEO 점수 100점을
                  달성했습니다.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 items-center md:flex md:justify-evenly">
              ...
              <div className="flex h-full flex-col justify-center gap-1 md:max-w-[400px]">
                ...
                <ul className="list-disc pl-7">
                  ...
                  <li>
                    서버와 클라이언트 상태의 동기화를 위해 React-Query
                    라이브러리 채택
                  </li>
                  <li>
                    프로젝트의 점증적 기능 구현을 고려한 프론트엔드 디렉토리
                    구조 설계 적용
                  </li>
                  <li>
                    ...
                    <ul className="list-disc pl-5 marker:text-slate-600">
                      ...
                      <li>
                        Next.js : 유저 최초 진입 시 서버사이드에서 쿠키 내
                        토큰을 받아 클라이언트의 세션 프로바이더에 주입
                      </li>
                      <li>
                ...
                <p>
                  ...
                  앱과 웹의 계정 연동 로직을 고민하고 해결한 경험, 개발이
                  진전됨에 따라 증가하는 디렉토리의 복잡도를 해소하며 프로젝트를
                  진행한 경험 등을 통해 규모가 큰 어플리케이션을 작업하는 것에
                  자신감을 얻게 되었습니다.
                </p>
              </div>
            </div>
          ...
          >
            <div className="grid grid-cols-1 items-center md:flex md:justify-evenly">
              ...
              <div className="flex h-full flex-col justify-center gap-1 md:max-w-[400px]">
                ...
                <p>
                  <span className="font-bold">회고록</span> : 로그인 정책을
                  어떻게 해야할지에 대해 많은 고민을 했던 프로젝트였습니다.
                  어드민 페이지는 보안이 중요하다는 것을 감안하여, 토큰에
                  자체적으로 제한 시간을 부여하여 매 요청간 토큰의 유효성 검증을
                  진행했습니다. 또한 어드민 페이지를 개발할때는 실 사용자와
                  충분한 대화를 나눠가며 구현해야 한다는 것을 몸소 깨닫게
                  되었습니다.
                </p>
              </div>
            </div>
          ...
          >
            <div className="grid grid-cols-1 items-center gap-3 md:flex md:justify-evenly">
              ...
              <div className="flex h-full flex-col justify-center gap-1 md:max-w-[400px]">
                ...
                <p>
                  <span className="font-bold">회고록</span> : 입사 후 바로 해당
          ...
          <InnerCard
            ...
            isNested
            cardTitle={
              <h4 className="text-xl">전세버스 수요조사 웹 프로젝트</h4>
            }
            ...
            <div className="grid grid-cols-1 items-center md:flex md:justify-evenly">
              ...
              <div className="flex h-full flex-col justify-center gap-1 md:max-w-[400px]">
                ...
                <p>
                  ...
                  네이버 클러스터링 API를 직접 뜯어보았고, 실시간 마커 스타일
                  변경 기능이 클러스터링 API 명세에 없는 기능이었다는 것을 알게
                  되었습니다.
                  <br />
                  다행히 네이버 클러스터링 API가 오픈소스로 공개된
                  기능이었으므로, 직접 코드를 해석하여 기존 클러스터링 코드
                  함수를 변경하는 과정을 통해 원하는 기능을 구현할 수 있었고,
                  O(n^3)로 동작하던 시간 복잡도를 O(n^2)로 고칠 수 있었습니다.
                </p>
              </div>
            </div>
          </InnerCard>
