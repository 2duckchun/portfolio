    ...
    >
      ...
      >
        <div className="m-auto max-w-[85%]">
          <p className="py-2">
            <b>저는 1년 간 현업에서 소중한 경험을 쌓았습니다.</b> 특히
            스타트업에서 홀로 프론트엔드단을 개발하며 프로젝트의 설계부터
            배포까지 전 과정을 아우를 수 있는 역량을 길렀습니다. 또한 백엔드
            개발자, 디자이너, 기획자 등 동료들과의 적극적인 의사소통을 통해 제가
            투입된 프로젝트를 어떻게든 잘 이끌어가고자 노력했습니다. 결과적으로
            짧은 기간동안 다양한 프로젝트를 성공적으로 출시할 수 있었습니다.
          </p>
          <p className="py-2">
            <b>저는 동료가 쉽게 읽을 수 있는 코드를 작성합니다.</b> 당장의
            구현에만 몰두하면 이후의 작업 속도는 더욱 더뎌진다는 사실을 실제
            개발 경험과 독서를 통해 깨닫게 되었습니다. 코드의 품질을 사수하는
            것도 개발자의 덕목이라 생각하며, 개발 도중 직관적이지 않거나 기능이
            지나치게 결합된 컴포넌트가 있다면 과감히 리팩터링을 진행합니다.
          ...
          <p className="py-2">
            ...
            끊임없이 찾아냅니다. 또한 개발 중 알아낸 지식에 대해 동료들과 함께
            토론하며 회사의 코드를 함께 개선해 나갑니다. 이러한 노력을 바탕으로
            함께 일한 동료로부터 최고의 동료 리뷰를 받았으며 이는{' '}
          ...
          <p className="py-2">
            <b>저는 끊임없이 배우고 있습니다.</b> 기초가 중요하다는 생각 아래
            한국방송통신대학교 컴퓨터과학과에 진학하여 주경야독 하고 있으며,
            격주로 동료 개발자들과 미팅하며 다양한 관점을 접하고자 노력합니다.
          </p>
          <p className="py-2">
